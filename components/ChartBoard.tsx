  ...
  return (
    <div className="w-full select-none">
        ...
        >
          ...
          <div className="text-center space-y-1">
            ...
            <div className="text-[10px] space-y-0.5" style={{ color: 'var(--t-faint)' }}>
              ...
              <div className="text-[9px]" style={{ color: 'var(--t-gold)', opacity: 0.5 }}>{chart.wuxingJuName}</div>
            </div>
          </div>
          ...
          <div className="text-[8px] text-center leading-relaxed font-mono" style={{ color: 'var(--t-faint)', opacity: 0.4 }}>
      ...
      <motion.div
        ...
        className="mt-3 flex items-center justify-center gap-2 text-[9px]"
      >
        {[
